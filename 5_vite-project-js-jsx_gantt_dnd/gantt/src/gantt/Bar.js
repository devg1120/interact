      ...
      {data.map((v, i) => {
        ...
        return (
          <g key={i} class="gantt-bar" style={{ cursor: 'pointer' }} onClick={handler}>
            ...
            //<rect class='gantt-bar-rect' x={x} y={y} width={w1} height={barHeight} rx={1.8} ry={1.8} style={bar.back} onClick={handler} />
            <rect class='gantt-bar-rect' x={x} y={y} width={w1} height={barHeight} rx={1.8} ry={1.8} style={bar.back}  />
		/*
            {w2 > 0.000001 ? <rect class='gantt-bar-rect' x={x} y={y} width={w2} height={barHeight} rx={1.8} ry={1.8} style={bar.front} /> : null}
	    */
            {v.type === 'group' ? null : (
              <g>
